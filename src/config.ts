...
export const PROBABILITY = {
    LIGHTNING: 0.03,
    SUPER_BOLT: 0.15,
    SUPER_BOLT_REACTION: 0.5,
    FOX_YAWN: 0.0008,
    EAR_TWITCH: 0.002,
    STARTLE_TRIGGERS_EYE: 0.4,
    FOX_BLINK: 0.005,
    HEDGEHOG: 0.0004,
    DEER: 0.0012,
    OWL_BLINK: 0.15,
...
export type TimeOfDay = 'day' | 'twilight' | 'night' | 'dawn';
export type Weather = 'clear' | 'rain' | 'fog' | 'snow' | 'storm' | 'wind';
export type SpecialEvent = 'halloween' | 'christmas' | 'bonfire' | 'birthday' | 'easter' | 'eclipse' | null;
 ...
 * time-of-day values
 */
export const TOD_BLEND: Record<TimeOfDay, number> = {
    dawn: 0.75,
    day: 1.0,
    twilight: 0.25,
    night: 0.0,
...
export const TABS = ['season', 'tod', 'weather', 'events', 'animals', 'fox'] as const;
