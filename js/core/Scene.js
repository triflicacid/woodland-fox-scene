 ...
 *
 * drawing components are registered in two arrays:
 *   - preFoxComponents: drawn before the fox (background layers, animals behind)
 *   - postFoxComponents: drawn after the fox (foreground trees, weather effects)
 *
 * to add a new drawing step, create a class with a draw(state) method and
 * call scene.register(component) or scene.registerPost(component).
 */
export class Scene {
    /**
